...
function SquidGame() {
  ...
  return (
    <Container>
      <Background>
        <img
          src="https://www.cercatoridiatlantide.it/wp-content/uploads/2021/10/SSQUID-GAME-COP-1200x640.jpg"
          alt=""
        />
      </Background>
      ...
      <ContentMeta>
        ...
        <SubTitle>2021 ‧ Drama ‧ 1 season</SubTitle>
        <Description>
          Hundreds of cash-strapped contestants accept an invitation to compete
