...
function PeakyBlinders() {
  const playMovie = () => {
    return (window.location.href = "/videos/peaky_blinders.mp4");
  };
  const playTrailer = () => {
  ...
  return (
    <Container>
      <Background>
        <img
          src="https://ntvb.tmsimg.com/assets/p14765800_b_h10_aa.jpg?w=1280&h=720"
          alt=""
        />
      </Background>
      ...
      <ContentMeta>
        ...
        <SubTitle>2013 ‧ Drama ‧ 6 seasons</SubTitle>
        <Description>
